...
async function extractMetrics(cookies, period = 'LAST_28D', platform = 'Facebook', businessId = null, assetId = null) {
  ...
  if (businessId && assetId) {
    ...
    // Si solo tiene assetId, incluir time_range Y platform en la URL
    url = `https://business.facebook.com/latest/insights/results?asset_id=${assetId}&time_range=${timeRange}&platform=${platform}`;
  } else {
